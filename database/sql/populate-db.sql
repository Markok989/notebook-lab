...
VALUES
    ('Maggie', 'Wiseman', 'm@m', 'maggiepass', 'teacher');

INSERT INTO users
    (first_name, last_name, email, password, role)
VALUES
    ('Ingrid', 'Majdalani', 'i@i', 'ingridpass', 'student');

INSERT INTO users
    (first_name, last_name, email, password, role)
VALUES
    ('Rebecca', 'Krummel', 'r@r', 'rebeccapass', 'student');
...
VALUES
    (1, FALSE, 'Rutherford Lab', 'https://www.dropbox.com/s/nsd1xcine2zzvdm/Lab_Rutherford.pdf', 'individual', 'individual', 'individual', 'individual', 'individual', 'individual', 'individual', 'individual', 'individual', 'individual');
