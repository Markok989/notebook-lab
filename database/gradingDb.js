...
- export finalReportGrade with value of function with parameters report_id, assignment_id, grade, comment, status
    ...
    - constant update has value of string `UPDATE students_reports SET status=$5, grade=$3, comments=$4 WHERE students_reports.id=$1 AND assignment_id=$2 RETURNING grade, comments, status`
    - constant result has value of db.query(update, [report_id, assignment_id, grade, comment, status])
    - returns result
*/
